...
std::vector<paddle::Tensor> LaunchWriteCacheKV(const paddle::Tensor& input_k, 
...
std::vector<paddle::Tensor> WriteCacheKV(const paddle::Tensor& input_k,
                                         const paddle::Tensor& input_v,
                                         const paddle::Tensor& cache_kv,
...
std::vector<std::vector<int64_t>> WriteCacheKVInferShape(const std::vector<int64_t>& input_k_shape, 
...
std::vector<paddle::DataType> WriteCacheKVInferDtype(const paddle::DataType& input_k_dtype,
                                                     const paddle::DataType& input_v_dtype, 
